## CODE TO FIT MODEL 3B WHEN GENERATIVE MODEL WAS DIFFERENT (MISSPECIFIED ALARM)

# Run tasks go from 1-15,19-24
...
########### FITTING MODEL 3B TO MODEL 1A DATA ##############
