## CODE TO FIT MODEL 1B WHEN GENERATIVE MODEL WAS DIFFERENT (MISSPECIFIED ALARM)

# Run tasks go from 1-3,7-24
...
########### FITTING MODEL 1B TO MODEL 1A DATA ##############
...
if run_task == 1
    ...
    @everywhere begin
        ...
        function LogPrior(p) 
            ...
            prior_H = logpdf(Gamma(3,20), H)
            return prior_α + prior_β + prior_δ + prior_H
        end
